...
class TruckTrip(Base):
    ...
    destination_facility_id = Column(Integer, ForeignKey("grinding_facilities.id"))
    freight_rate_per_ton = Column(BigInteger, nullable=False, default=8700000)
    total_freight_cost = Column(BigInteger, nullable=True)
    ...
    destination_facility = relationship("GrindingFacility")
